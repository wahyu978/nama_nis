...
<head>
    ...
    <title>Aplikasi Kasir - Nama</title>
        ...
        <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    ...
                    <div class="col-lg-12 text-center mt-4 mb-0">
                        <h1 class="text-primary mb-1" >Selamat Datang di Aplikasi Kasir !</h1>
                            ...
                            <div class="col-lg-6"> 
                                ...
                                <div class="p-5">
                                    <div class="text-center">
                                        <!-- <h1 class="h4 text-gray-900 mb-1">Selamat Datang di</h1> -->
                                        <!-- <h1 class="h4 text-gray-900 mb-4">Aplikasi Kasir</h1> -->
                                        <h1 class="h3 text-gray-900 mb-4">Silahkan Login !</h1> <br> 
                                    </div>
